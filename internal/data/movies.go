...
func (m MovieModel) Update(movie *Movie) error {
	// checking for the version allows us to prevent race condition when the same resource is being updated at the same time
	query := `
		UPDATE movies
...
// arguments are the filter parameters
